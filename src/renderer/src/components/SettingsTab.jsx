  ...
  return (
    <div style={{ maxWidth: '800px' }}>
            ...
            >
              <div
                ...
                style={{
                  ...
                  cursor: 'pointer',
                  backgroundColor:
                    exportQuality === '1080p' ? 'var(--surface-high)' : 'transparent',
                  color: exportQuality === '1080p' ? '#fff' : 'var(--on-surface-variant)'
                }}
              >
                1080p
              </div>
              ...
              <div
                ...
                style={{
                  ...
                  cursor: 'pointer',
                  backgroundColor:
                    exportQuality === '4K UHD' ? 'var(--surface-high)' : 'transparent',
                  color: exportQuality === '4K UHD' ? '#fff' : 'var(--on-surface-variant)'
                }}
              >
                4K UHD
              </div>
            ...
            >
              <div
                ...
                style={{
                  ...
                  cursor: 'pointer',
                  backgroundColor:
                    aspectRatio === 'Original' ? 'var(--surface-high)' : 'transparent',
                  color: aspectRatio === 'Original' ? '#fff' : 'var(--on-surface-variant)'
                }}
              >
                <span
                  className="material-symbols-outlined"
                  style={{ fontSize: '14px', verticalAlign: 'middle', marginRight: '6px' }}
                >
                  aspect_ratio
                </span>
                Original
              ...
              <div
                ...
                style={{
                  ...
                  fontSize: '13px',
                  cursor: 'pointer',
                  backgroundColor: aspectRatio === '9:16' ? 'var(--surface-high)' : 'transparent',
                  color: aspectRatio === '9:16' ? '#fff' : 'var(--on-surface-variant)'
                }}
              >
                <span
                  className="material-symbols-outlined"
              ...
              <div
                ...
                style={{
                  ...
                  fontSize: '13px',
                  cursor: 'pointer',
                  backgroundColor: aspectRatio === '1:1' ? 'var(--surface-high)' : 'transparent',
                  color: aspectRatio === '1:1' ? '#fff' : 'var(--on-surface-variant)'
                }}
              >
                <span
                  className="material-symbols-outlined"
            ...
            >
              <div
                ...
                style={{
                  ...
                  cursor: 'pointer',
                  backgroundColor:
                    codecFormat === 'Software x264' ? 'var(--surface-high)' : 'transparent',
                  color: codecFormat === 'Software x264' ? '#fff' : 'var(--on-surface-variant)'
                }}
              >
                Software (x264)
              </div>
              ...
              <div
                onClick={() => {
                  if (hasNvidia) setCodecFormat('NVIDIA NVENC')
                }}
                style={{
                  flex: 1,
                  padding: '10px',
                  ...
                  backgroundColor:
                    codecFormat === 'NVIDIA NVENC' ? 'var(--surface-high)' : 'transparent',
              ...
              >
                ...
                {!hasNvidia && (
                  <span
                    className="material-symbols-outlined"
                    style={{ fontSize: 12, verticalAlign: 'middle', marginLeft: 4 }}
                  >
                    lock
                  </span>
                )}
              ...
              <div
                onClick={() => {
                  if (isMac) setCodecFormat('Apple VideoToolbox')
                }}
                style={{
                  flex: 1,
                  padding: '10px',
                  ...
                  backgroundColor:
                    codecFormat === 'Apple VideoToolbox' ? 'var(--surface-high)' : 'transparent',
                  color:
                    codecFormat === 'Apple VideoToolbox' ? '#fff' : 'var(--on-surface-variant)',
                  opacity: isMac ? 1 : 0.4
                }}
        ...
        >
          <div>
            ...
            <div style={{ fontSize: '12px', color: 'var(--on-surface-variant)' }}>
              Automatically generate trims and apply color profiles immediately after source footage
              is uploaded to the pool.
            </div>
          </div>
          <div
            ...
            style={{
              ...
              height: '24px',
              borderRadius: '12px',
              backgroundColor: autoProcess ? '#c4b5fd' : 'var(--surface-highest)',
              position: 'relative',
              cursor: 'pointer',
        ...
        <div style={{ marginTop: '8px' }}>
          ...
          {shouldRemoveSilence && (
            <div
              ...
              style={{ marginBottom: silencePreset === 'custom' ? 16 : 0 }}
            >
              <Label
                style={{ marginBottom: 8, display: 'block', color: 'var(--on-surface-variant)' }}
              >
              ...
              <Select value={silencePreset} onValueChange={handlePresetChange}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="conservative">
                    Conservative - -40dB / 0.8s (Only long pauses)
                  </SelectItem>
              ...
              >
                {silencePreset === 'standard' &&
                  'Ideal for most podcasts. Removes standard pauses without making speech sound unnatural.'}
                {silencePreset === 'conservative' &&
                  'Safest option. Only removes very obvious, long gaps. Preserves natural breathing.'}
                {silencePreset === 'aggressive' &&
                  'Snappy pacing. Removes almost all dead air between words. Can sound choppy.'}
      ...
      <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '16px', marginTop: '24px' }}>
        <Button
          variant="outline"
          style={{ backgroundColor: 'transparent', borderColor: 'var(--outline)', color: '#fff' }}
        >
          Reset Defaults
        </Button>
        <Button style={{ backgroundColor: '#c4b5fd', color: '#121212', fontWeight: 600 }}>
          Save Changes
        </Button>
      </div>
    </div>
