    ...
    <div style={{ display: 'flex', gap: '24px', height: '100%', flexDirection: 'column' }}>
      ...
      >
        <div className="card" style={{ marginBottom: 0 }}>
          ...
          <div className="form-group">
            ...
            >
              <label style={{ margin: 0 }}>
                Source Video <span style={{ color: 'var(--error)' }}>*</span>
              </label>
              <span
                style={{
                  fontSize: '10px',
          ...
          <div className="form-group">
            ...
            >
              <label style={{ marginBottom: 0 }}>
                Trimming CSV <span style={{ color: 'var(--error)' }}>*</span>
              </label>
              <span
                style={{
                  fontSize: '10px',
              ...
              <div style={{ display: 'flex', gap: 8, backgroundColor: 'transparent', padding: 0 }}>
                <div
                  ...
                  style={{
                    ...
                    cursor: 'pointer',
                    fontSize: 14,
                    backgroundColor: inputMode === 'csv' ? 'var(--primary)' : 'transparent',
                    color: inputMode === 'csv' ? '#fff' : 'var(--on-surface-variant)',
                    userSelect: 'none'
                  }}
                >
                  CSV Upload
                ...
                <div
                  ...
                  style={{
                    ...
                    cursor: 'pointer',
                    fontSize: 14,
                    backgroundColor: inputMode === 'manual' ? 'var(--primary)' : 'transparent',
                    color: inputMode === 'manual' ? '#fff' : 'var(--on-surface-variant)',
                    userSelect: 'none'
                  }}
                >
                  Manual Input
          ...
          <div className="form-group">
            <label>
              Output Directory <span style={{ color: 'var(--error)' }}>*</span>
            </label>
            <div
              className="dropzone"
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <div
              style={{
                ...
                backgroundColor: inputVideo ? 'var(--primary)' : 'transparent'
              }}
            ></div>
            <span style={{ fontSize: '13px', color: 'var(--on-surface-variant)' }}>
              Source: {inputVideo ? 'Ready' : 'Pending'}
            </span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <div
              style={{
                ...
                border: '2px solid var(--outline)',
                backgroundColor:
                  (inputMode === 'csv' && csvPath) ||
                  (inputMode === 'manual' && manualClips.length > 0)
                    ? 'var(--primary)'
                    : 'transparent'
              }}
            ></div>
